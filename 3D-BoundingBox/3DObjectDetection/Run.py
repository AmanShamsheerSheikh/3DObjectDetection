...
def plot_regressed_3d_bbox(img, cam_to_img, box_2d, dimensions, alpha, theta_ray, img_2d=None):
    ...
    pt1,pt2,pt2,pt4=plot_3d_box(img, cam_to_img, orient, dimensions, location) # 3d boxes
    pts = [pt1,pt2,pt2,pt4]
    return location,pts
...
def main():
    ...
    #         image_dir = "eval\video\output_video.avi"
    #         cal_dir = "eval\calib"


    # img_path = os.path.abspath(os.path.dirname(__file__)) + "/" + image_dir
    # img_path = r"C:\Users\Aman Sheikh\Desktop\3dObjectDetection\data/"
    ...
    #     exit()
    # print(ids)
    # cap = cv2.VideoCapture(r"C:\Users\Aman Sheikh\Desktop\3dObjectDetection\3D-BoundingBox\eval\video\output_video.avi")
    cap = cv2.VideoCapture("WhatsApp Video 2022-12-16 at 2.18.33 PM.mp4")
    while cap.read():
        ...
        for detection in detections:
            ...
            if FLAGS.show_yolo:
                ...
                location,pts = plot_regressed_3d_bbox(img, proj_matrix, box_2d, dim, alpha, theta_ray)
            # ptslist.append(pts)
